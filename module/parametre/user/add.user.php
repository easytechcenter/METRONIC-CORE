...
define("PAGE", "Ajout d'un Utilisateur"); // Nom de la Page
?>
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Ajout d'un Utilisateur</h2>
                </div>                   
                            ...
                            <form class="form-horizontal" action="<?php echo SITE_URL,RACINE; ?>fonction/user.php" method="POST">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong>Nouvel</strong> Utilisateur</h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div role="alert" class="alert alert-success">
                                            <button data-dismiss="alert" class="close" type="button"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                                            <i class="fa fa-check"></i> <strong>Succès!</strong> L'utilisateur à été créer.
                                        </div>
                                        <?php
                                            }
                                        ?>
                                        ...
                                        <div role="alert" class="alert alert-danger">
                                            <button data-dismiss="alert" class="close" type="button"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
                                            <i class="fa fa-times"></i> <strong>Erreur!</strong> L'utilisateur n'a pas été créer.
                                        </div>
                                        <?php
                                            }
                                        ?>
                                    ...
                                    <div class="panel-body">                                                                        
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" placeholder="Le nom d'utilisateur est indispensable pour la connexion" name="login" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <button type="submit" class="btn btn-success btn-lg" name="add-user" value="Valider"><i class="fa fa-check"></i> Ajouter un utilisateur</button>
                                            </div>
                                            <div class="col-md-4"></div>
                                        </div>
