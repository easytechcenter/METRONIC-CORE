    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                $sql_message = mysql_query("SELECT * FROM messagerie, boite_envoie, utilisateur WHERE boite_envoie.expediteur = utilisateur.iduser AND messagerie.idmessage = '$idmessage'")or die(mysql_error());
